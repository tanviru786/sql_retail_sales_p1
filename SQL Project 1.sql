...
-- Q.1 Write a SQL query to retrieve all columns for sales made on 2022-11-08.
...
-- Q.8 Write a SQL query to find the top 5 customers bas
...
SELECT 
	category,
	COUNT(DISTINCT customer_id) as cnt_unique_cs -- Count of unique customers.
FROM retail_sales
GROUP BY category
